    ...
    <footer className="relative z-10 bg-black text-white py-6 md:py-10 border-t border-white/10">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center gap-4 md:gap-6 mb-6 md:mb-8">
          ...
          <a href="https://x.com/ict_dinesh" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
            <FaXTwitter size={20} className="md:w-6 md:h-6" />
          </a>
          <a href="https://discord.gg/HavyeuEgrQ" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
